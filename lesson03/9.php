<!DOCTYPE html>
    ...
    <pre>
        ...
        *  производит транслитерацию и замену пробелов
        *  на подчеркивания (аналогичная задача решается при
        *  конструировании url-адресов на основе названия статьи в блоках).
        */
    ...
    <p class="margin-left"><b>Результат:</b></p>
        ...
        <form class="margin-left" method="post" action="9.php">
